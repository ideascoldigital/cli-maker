  ...
  describe('Number validations', () => {
    const cases: any = [
      ...
      },
      {
        ...
        data: "veinte",
        type: ParamType.Number,
        expectedError: "\n ERROR  Invalid number format: 'veinte'\n       Expected: whole numbers only (e.g., 42)\n",
        expectedValue: undefined,
        required: true,
      },
      {
        ...
        data: "doce",
        type: ParamType.Number,
        expectedError: "\n ERROR  Invalid number format: 'doce'\n       Expected: whole numbers only (e.g., 42)\n",
        expectedValue: undefined,
        required: false,
      },
      {
  ...
  describe('Email validations', () => {
    const cases: any = [
      ...
      },
      {
        ...
        data: "bademail.com",
        type: ParamType.Email,
        expectedError: "\n ERROR  Invalid email format: 'bademail.com'\n       Expected: user@domain.com\n",
        expectedValue: undefined,
        required: true,
      },
      {
  ...
  describe('URL validations', () => {
    const cases: any = [
      ...
      },
      {
        ...
        data: "badurlcom",
        type: ParamType.Url,
        expectedError: "\n ERROR  Invalid URL format: 'badurlcom'\n       Expected: https://example.com or http://example.com\n",
        expectedValue: undefined,
        required: true,
      },
      {
  ...
  describe('List validations', () => {
    const cases: any = [
      ...
      },
      {
        ...
        data: "some",
        type: ParamType.List,
        expectedError: "\n ERROR  List parameter has no options configured\n",
        expectedValue: undefined,
        required: true,
      },
      {
      ...
      },
      {
        ...
        data: "zarzamora",
        type: ParamType.List,
        expectedError: "\n ERROR  Invalid option: 'zarzamora'\n       Available options: pera, tomate, banana\n",
        expectedValue: undefined,
        required: true,
        options: ["pera", "tomate", "banana"]
      },
  ...
  describe('package validations', () => {
    const cases: any = [
      ...
      },
      {
        ...
        data: "whatever",
        type: ParamType.Package,
        expectedError: "\n ERROR  Invalid package format: 'whatever'\n       Expected: @company/package-name\n",
        expectedValue: undefined,
        required: false,
      },
      {
        ...
        data: "badpackagecom",
        type: ParamType.Package,
        expectedError: "\n ERROR  Invalid package format: 'badpackagecom'\n       Expected: @company/package-name\n",
        expectedValue: undefined,
        required: true,
      },
      {
        ...
        data: "badurlcom",
        type: ParamType.Package,
        expectedError: "\n ERROR  Invalid package format: 'badurlcom'\n       Expected: @company/package-name\n",
        expectedValue: undefined,
        required: false,
      },
      {
